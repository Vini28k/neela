/*
  ...
  4. Functions & Triggers
    ...
    - User activity view for analytics
*/
...
SELECT drop_policy_if_exists('profiles', 'Users can read own profile');
...
SELECT drop_policy_if_exists('profiles', 'Service role can manage all profiles');

SELECT drop_policy_if_exists('weather_states', 'Users can read own weather states');
SELECT drop_policy_if_exists('weather_states', 'Users can insert own weather states');
SELECT drop_policy_if_exists('weather_states', 'Users can update own weather states');
SELECT drop_policy_if_exists('weather_states', 'Service role can manage all weather states');

SELECT drop_policy_if_exists('heart_rate_data', 'Users can read own heart rate data');
SELECT drop_policy_if_exists('heart_rate_data', 'Users can insert own heart rate data');
SELECT drop_policy_if_exists('heart_rate_data', 'Users can update own heart rate data');
SELECT drop_policy_if_exists('heart_rate_data', 'Service role can manage all heart rate data');

SELECT drop_policy_if_exists('emergency_contacts', 'Users can read own emergency contacts');
SELECT drop_policy_if_exists('emergency_contacts', 'Users can insert own emergency contacts');
SELECT drop_policy_if_exists('emergency_contacts', 'Users can update own emergency contacts');
SELECT drop_policy_if_exists('emergency_contacts', 'Users can delete own emergency contacts');
SELECT drop_policy_if_exists('emergency_contacts', 'Service role can manage all emergency contacts');

SELECT drop_policy_if_exists('ml_predictions', 'Users can read own ML predictions');
SELECT drop_policy_if_exists('ml_predictions', 'Service role can manage ML predictions');

SELECT drop_policy_if_exists('user_baselines', 'Users can read own baselines');
SELECT drop_policy_if_exists('user_baselines', 'Service role can manage baselines');

SELECT drop_policy_if_exists('notification_logs', 'Users can read own notifications');
SELECT drop_policy_if_exists('notification_logs', 'Service role can manage notifications');
